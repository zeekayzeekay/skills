...
- **[implement-spec](./implement-spec/SKILL.md)**: Implement a whole spec as one PR, running implementer subagents across the ticket frontier with shared delivery context, calibrated review fixes and an explicit readiness handoff. User-invoked.
